...
const faqItems: FAQItem[] = [
  {
    question: '내일뉴는 어떤 회사인가요?',
    answer: '내일뉴는 나주 지역 청년들을 위한 문화 네트워킹 서비스를 제공하는 청년 문화 기업입니다. 2023년 설립 이후 1,000명 이상의 회원과 함께 매주 10개 이상의 문화 프로그램을 운영하고 있습니다. 종교, 정치, 이념과 무관한 순수 문화 서비스 기업입니다.'
  },
  {
  ...
  },
  {
    ...
    answer: '네, 가능합니다. 지역 기업과의 제휴를 통해 회원 복지 혜택을 확대하고 있습니다. 기업 단체 회원 가입, 프로그램 후원, 공간 제공 등 다양한 형태의 협력이 가능합니다. 자세한 문의는 partnership@브릿지온으로 연락주세요.'
  },
  {
